...
if [ "$HOSTNAME" = "framework" ]; then
	...
	amixer -M set Front playback unmute
	amixer -M set Line playback unmute
	amixer -M set Surround playback unmute
	amixer -M set Center playback unmute
	amixer -M set LFE playback unmute
	amixer -M set Headphone 100% unmute
	amixer -M set Master playback toggle
else
